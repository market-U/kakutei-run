...
import { calcJumpVelocity, calcChargeScale, calcChargeScaleX } from "../systems/gameUtils";
...
export class Player extends Phaser.Physics.Arcade.Sprite {
  ...
  update(): void {
    ...
    if (chargeAmount > 0) {
      this.setScale(calcChargeScaleX(chargeAmount), calcChargeScale(chargeAmount));
    } else {
      this.setScale(1, 1);
    }
  }
